  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Студия дизайна интерьеров · Japandi-эстетика
        </p>
        ...
        >
          Интерьеры,
          <span className="block text-sage">которые говорят</span>
          о вас
        </h1>
        ...
        >
          Создаём жилые и коммерческие пространства в стиле Japandi — где каждый предмет несёт смысл, а каждая деталь работает на ощущение дома.
        </p>
